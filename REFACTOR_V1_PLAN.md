...
- **Modify** `index.html` (formerly `playable-dungeon-crawler-v2.html`, renamed 2026-04-28) — remove the 3,000-line inline `<script>` body; add `<script src>` tags in dependency order; keep templates, CSS link, and the tiny template-loading bootstrap.
